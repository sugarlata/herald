...
@Component({
  selector: 'adoption-ani-one',
  templateUrl: 'adoption-ani-one.html'
})
...
export class AdoptionAniOneComponent {
  ...
  setupFirstBase() {
    ...
    // Show God Circle
    this.animExec = this.showFirstBase;
  ...
  showScene11() {
    ...
    let x = (this.screenWidth / 2) - (this.ropeGod.width / 2);
    let y = this.screenHeight / 2;
    this.charmFather.slide(this.ropeGod, x, y);
    // this.ropeGod.x = 0;
  ...
  hideScene11() {
    ...
    this.charmFather.slide(this.ropeGod, this.godStartX, this.godStartY);

  }

  animShowScene12(delta) {
    ...
    if (this.spritePerson.alpha >= .95){
        ...
        this.timer2 += 0.012
        this.spritePerson.alpha = this.timer2;
    }
    
  }

  animHideScene12(delta) {
  ...
  showScene12() {
    this.timer2 = 0;
    this.animExec2 = this.animShowScene12;
  }

  hideScene12() {
      this.timer2 = 1;
      this.animExec2 = this.animHideScene12;
  }
